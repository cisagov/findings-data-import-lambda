...
"""findings_data_import: A tool for extracting, transforming
...
def import_data(
    ...
    try:
        ...
        db_connection = MongoClient(host=f'mongodb://{db_hostname}:{db_port}', serverSelectionTimeoutMS=2500, tz_aware=True)
        ...
        logging.info(f"Deleted temporary {data_filename} and {temp_field_data_filepath} from local filesystem")
